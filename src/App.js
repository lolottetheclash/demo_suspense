  ...
  return (
    <div className="App">
      ...
      <ol>
        ...
        <li>Après 2 secondes, les données du user sont chargées.</li>
        <li>
          Le composant "Posts" lance la récupération de ses propres données dans
          le useEffect.
        </li>
        <li>Après 3 secondes, les données des Posts sont chargées.</li>
        <p style={{ color: 'red' }}>
          ...
          cela prend 5 secondes en tout pour charger les données.
        </p>
      </ol>
